...
module.exports = function(Chart) {
	...
	// Scatter charts use line server.controllers
...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.Controller.prototype, /** @lends Chart.Controller */ {
		...
		initialize: function() {
			...
			// Make sure server.controllers are built first so that each dataset is bound to an axis before the scales
			// are built
		...
		update: function(animationDuration, lazy) {
			...
			// Make sure dataset server.controllers are updated and new server.controllers are reset
			var newControllers = me.buildOrUpdateControllers();

			// Make sure all dataset server.controllers have correct meta data counts
			helpers.each(me.data.datasets, function(dataset, datasetIndex) {
			...
			// Can only reset the new server.controllers after the scales have been updated
...
module.exports = function(Chart) {
	...
	// Base class for all dataset server.controllers (line, bar, etc)
